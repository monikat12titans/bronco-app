...
class CustomerListResponse extends APIStatus {
  List<UserData>? data;

  CustomerListResponse(int status, int code, String message, this.data)
  ...
  factory CustomerListResponse.fromJson(Map<String, dynamic> json) {
    ...
    return CustomerListResponse(json['status'] as int, json['code'] as int,
